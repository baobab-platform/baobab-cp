...
func (f *bindingStoreFake) GetCapability(context.Context, string) (capabilitydomain.Capability, error) { return f.capability, nil }
func (f *bindingStoreFake) GetCapabilityScope(context.Context, string) (capabilitydomain.CapabilityScope, error) { return f.scope, nil }
func (f *bindingStoreFake) ListBindings(context.Context, string) ([]resolver.CapabilityBinding, error) { return f.bindings, nil }
func (f *bindingStoreFake) CreateBinding(_ context.Context, b resolver.CapabilityBinding) error { f.bindings = append(f.bindings, b); return nil }
func (f *bindingStoreFake) ListActiveInstances(context.Context, string) ([]resolver.EngineInstance, error) { return f.instances, nil }

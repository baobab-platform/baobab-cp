...
var undescribed = []string{
	...
	"POST /v1/canonical-entities/{}/iam-organisations",
	...
	"POST /v1/counterparty-roles/{}/end",
	"POST /v1/iam-organisation-references/{}/retire",
	"POST /v1/organisation-reconciliation",
